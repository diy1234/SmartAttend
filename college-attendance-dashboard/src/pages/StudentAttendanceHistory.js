  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl font-bold text-blue-900 mb-6">📘 Attendance History</h1>
  ...
  <table className="min-w-full bg-white border-collapse">
    ...
    <thead className="bg-gray-100 text-sm text-gray-700 border-b border-gray-300">
      <tr>
        ...
        <th className="px-4 py-3 border-r border-gray-300 text-left">Status</th>
        <th className="px-4 py-3 border-r border-gray-300 text-left">Method</th>
      ...
      {loading ? (
        ...
        paginated.map((rec, idx) => (
          ...
          >
            ...
            <td className="px-4 py-3 border-r border-gray-200 flex items-center gap-2">
              <MethodIcon rec={rec} />
              {methodLabel(rec)}
            </td>

            <td className="px-4 py-3">{whoMarked(rec)}</td>
          </tr>
        ))
      )}
    </tbody>
